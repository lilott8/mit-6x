...
def getWordScore(word, n):
    ...
    for x in word:
        score += int(SCRABBLE_LETTER_VALUES[x])
    score = score * letters_used
    if letters_used >= n and letters_used > 0:
        score += 50
    return score
#
    ...
    while calculateHandlen(hand) > 0:
        ...
        # Otherwise (the input is not a single period):
            ...
            # Otherwise (the word is valid):
                ...
                value = getWordScore(user_input, n)
                score += value
                print '"' + user_input + '" earned ' + str(value) + ' points. Total: ' + str(score) + ' points'
...
def playGame(wordList):
    ...
    #playHand({'c':1, 'a':1, 't':1}, wordList, 3)
    user_input = 'a'
    while user_input != 'e':
        ...
        if user_input == 'e':
            ...
            try:
                ...
                length = 0
            if length > 1:
                playHand(backup.copy(), wordList, HAND_SIZE)
            else:
...
if __name__ == '__main__':
    wordList = loadWords()
    #print isValidWord('bit', {'a': 1, 'b':1, 't':2, 'i':1}, wordList)
    #print isValidWord('bit', {'a': 1, 'b':1, 't':2}, wordList)
    playGame(wordList)
